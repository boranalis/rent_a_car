...
include ("baglanti.php");
$sql = "SELECT rezId, alisTarihi, iadeTarihi, mAd, mSoyad, marka, model, sSehir FROM rezervasyon,musteri,araba,personel,sube WHERE rezervasyon.musteriId=musteri.musteriId and rezervasyon.arabaId=araba.arabaId and rezervasyon.personeld=personel.personeld and rezervasyon.subeId=sube.subeId ";
$result = $baglanti->query($sql);

if ($result->num_rows > 0) {
    echo "<table><tr><th>ID</th><th>Kira Tarihi</th><th>İade Tarihi</th><th>Kiralayan Adı</th><th>Kiralayan Soyadı</th><th>Kiralanan Araç</th><th>Araç Modeli</th><th>Sube Konumu</th><th>Iptal</th></tr>";
    ...
    while($row = $result->fetch_assoc()) { ?>
      <tr>
        ...
        <td><a href = "rezervesil.php?rezId=<?php echo $row["rezId"]; ?>">Iptal </td>
      </tr>
